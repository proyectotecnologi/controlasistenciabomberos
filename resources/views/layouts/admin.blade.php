...
<head>
  ...
  <title>SISTEMA DE CONTROL DE ASISTENCIA DE BOMBEROS</title>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{url('/')}}" class="brand-link" style="padding: 20px; display: flex; flex-direction: column; align-items: center;">
        <img src="{{url('/images/bomberos.jpg')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="width: 70px; height: 70px;">
        <span class="brand-text font-weight-light" style="margin-left: 10px; font-size: 14px;">SISTEMA CONTROL DE ASISTENCIA</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex flex-column align-items-center">
          <div class="image">
            <img src="{{ asset('storage/' . (Auth::user()->fotografia ?? 'default1.jpg')) }}" class="img-circle elevation-2" alt="User Image" style="width: 90px; height: 90px; object-fit: cover;">
          </div>
          <div class="info">
