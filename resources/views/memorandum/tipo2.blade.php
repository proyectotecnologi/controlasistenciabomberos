...
<head>
    ...
    <title>Memorándum Leve - Policía Boliviana</title>
    <style>
        @page {
            size: letter;
            margin: 1.5cm 2cm;
...
<body>
    ...
    <div class="content">
        ...
        <div class="body-text">
            ...
            <span class="highlight">(LLAMADA DE ATENCIÓN ESCRITA Y ARRESTO DE 10 DÍAS)</span>, 
            por haber infringido el Cap. II, Art. 11, Numeral 12, de la Ley 101, Ley del Régimen Disciplinario 
            de la Policía Boliviana, que a la letra dice: <span class="highlight">"INASISTENCIA O ABANDONO INJUSTIFICADO DE SUS FUNCIONES, POR DOS DÍAS CONTINUOS CON SANCIÓN DE CINCO A DIEZ DÍAS DE ARRESTO O SU EQUIVALENTE EN TRABAJO EN FINES DE SEMANA Y FERIADOS "</span>. 
